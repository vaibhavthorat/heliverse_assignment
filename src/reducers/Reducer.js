...
export function EmployeesReducer(state = initialState, action) {
  ...
  switch (action.type) {
    case "SALES_FILTER":
    let result=state.items.filter((p1) => p1.domain === "Sales");
    ...
    case "FINANCE_FILTER":
      let finance=state.items.filter((p1) => p1.domain === "Finance");
      return{
        ...state,
        items: finance,
    }

    case "MANAGEMENT_FILTER":
      let Management=state.items.filter((p1) => p1.domain === "Management");
      return{
        ...state,
        items: Management,
    }
    case "IT_FILTER":
      let IT=state.items.filter((p1) => p1.domain === "IT");
      return{
        ...state,
        items: IT,
    }
    ...
    case "UIDESIGNING_FILTER":
      let UIDesigning=state.items.filter((p1) => p1.domain === "UI Designing");
      return{
        ...state,
        items: UIDesigning,
    }
    case "MARKETING_FILTER":
      let Marketing=state.items.filter((p1) => p1.domain === "Marketing");
      return{
        ...state,
        items: Marketing,
    }
    case "BUSINESSDEVELOPMENT_FILTER":
      let BusinessDevelopment=state.items.filter((p1) => p1.domain === "Business Development");
      return{
        ...state,
        items: BusinessDevelopment,
    }
    case "MALE_FILTER":
      let Male=state.items.filter((p1) => p1.gender === "Male");
      return{
        ...state,
        items: Male,
    }
    case "FEMALE_FILTER":
      let Female=state.items.filter((p1) => p1.gender === "Female");
      return{
        ...state,
        items: Female,
    }
    case "AVAILABLE_FILTER":
      let valtrue=state.items.filter((p1) => p1.available === true);
      return{
        ...state,
        items: valtrue,
    }
    case "UNAVAILABLE_FILTER":
      let valfalse=state.items.filter((p1) => p1.available === false);
      return{
        ...state,
        items: valfalse,
    }
    case "SEARCH_FILTER":
      ...
      let searchresult=state.items.filter((p1) => p1.first_name.concat(p1.last_name).toLowerCase().includes(action.payload.query.toLowerCase()) && p1.first_name.concat(p1.last_name)!==action.payload.query.toLowerCase());
      return{
        ...state,
        items: searchresult,
    }
    
    case "SEARCH_FILTER_NORMAL":
    return{
      ...state,
      items:state.items
  }
